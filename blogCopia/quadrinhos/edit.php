...
<html lang="en">
  ...
  <body>
    ...
    <a href="view.php" class="btn btn-danger">Voltar</a>

        <?php foreach($query as $q){?>
            <form method="POST" enctype="multipart/form-data">
              <input type="hidden" name="bookId" value="<?php echo $q["bookId"]?>">
              <input name="name" type="text" placeholder="Nome do quadrinho" class="form-control bg-dark text-white my-3 text-center" 
              ...
              <input name="episode_progress" type="number" placeholder="Progresso de páginas" class="form-control bg-dark text-white my-3"
