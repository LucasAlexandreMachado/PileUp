...
<html lang="en">
  ...
  <body>
    ...
    <input type='button' class="btn btn-danger" style="" value='Voltar' onclick='history.go(-1)' />
      <form method="POST" enctype="multipart/form-data">
        ...
        <select name="status" class="form-control bg-dark text-white my-3" required>
          ...
          <option value="pretendo ler">Pretendo ler</option>
          <option value="completo">Completo</option>
          <option value="relendo">Relido</option>
        ...
        <input
          ...
          type="number"
          placeholder="Progresso de páginas"
          class="form-control bg-dark text-white my-3"
          required
        />
        <textarea
    ...
    <input type="submit" name="new_post" value="Adicionar quadrinho" class="btn-primary"/>
      </form>
    </div>
